...
- Homepage/Projects landing cards use the original project media, matching the detailed project pages.
...
- Homepage project-highlight media uses the same light/unboxed treatment rather than the legacy dark/blurred frame.
...
- Project-highlight media no longer contains a dormant dark/blurred framing path; original project imagery is unboxed at the component level.
...
- Project demo and highlight images use the original media dimensions so lazy loading does not collapse mobile layout before media enters the viewport.
