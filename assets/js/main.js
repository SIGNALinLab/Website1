...
function renderHeader(){
  ...
  document.querySelector('#site-header').innerHTML=`<a class="skip-link" href="#main">Skip to content</a><header class="site-header"><div class="header-signal" aria-hidden="true"></div><div class="container nav-wrap"><a class="brand" href="index.html"><span class="brand-symbol"><img src="assets/brand/symbol.svg" alt=""></span><span class="brand-copy"><strong>SIGNAL Lab</strong><small>Qassim University · College of Engineering</small></span></a><button class="nav-toggle" aria-expanded="false" aria-controls="site-nav"><span class="nav-toggle-lines" aria-hidden="true"></span><span class="sr-only">Menu</span></button><nav id="site-nav" class="site-nav" aria-label="Primary"><ul><li><a href="index.html" ${page==='home'?'aria-current="page"':''}>Home</a></li><li><a href="publications.html" ${page==='publications'?'aria-current="page"':''}>Publications</a></li><li><a href="projects.html" ${currentProjects?'aria-current="page"':''}>Projects</a></li><li><a href="people.html" ${page==='people'?'aria-current="page"':''}>People</a></li><li><a href="admissions.html" ${currentAdmissions?'aria-current="page"':''}>Admissions &amp; Aid</a></li><li><a href="equipment.html" ${page==='equipment'?'aria-current="page"':''}>Equipment</a></li><li><a href="contact.html" ${page==='contact'?'aria-current="page"':''}>Contact</a></li></ul></nav></div></header>`;
